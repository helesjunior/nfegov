...
class CodigoItemCrudController extends CrudController
{
    ...
    public function setup()
    {
        ...
        CRUD::setRoute(config('backpack.base.route_prefix') . '/codigo-item');
        CRUD::setEntityNameStrings('codigo item', 'codigo items');
    }
